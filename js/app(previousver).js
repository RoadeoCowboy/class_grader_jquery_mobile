...
// $( "#HWLab" ).on( "flipswitchcreate", function( event, ui ) {
//   alert($('#HWLab').val());
// } );

// $('#HWLab').on('change', function(){
//   alert($('#HWLab').val());
// });

// $('#Project').change(function(){
//   console.log('Hello' + $('#Project').val());
// });

$(document).ready(function(){
    
    var HomeworksPercent;
    var LabsPercent;
    var ProjectPercent;
    var PresentationPercent;
    var MidtermPercent;
    var FinalPercent;
    // var HWLab = "off";  //initial values
    // var Project = "off";
    // var Exam = "off";
